...
void Movement::attackRamp(int targetSpeed, int rampRate) {
    int currentSpeed = 0;
    ...
    analogWrite(Lneg, 0);
    while(digitalRead(LSensor) && digitalRead(RSensor)) {
